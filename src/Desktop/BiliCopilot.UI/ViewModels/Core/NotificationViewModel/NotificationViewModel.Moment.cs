        ...
        try
        {
            ...
            foreach (var moment in newMoments)
            {
                ...
                if (moment.Data is VideoInformation vinfo)
                {
                    ...
                    arguments = JsonSerializer.Serialize(vinfo.Identifier, JsonContext.Default.MediaIdentifier);
                }
                else if (moment.Data is EpisodeInformation einfo)
                {
                    ...
                    if (hasEpid)
                    {
                        ...
                        arguments = JsonSerializer.Serialize(identifier, JsonContext.Default.MediaIdentifier);
                    }
                    else
                    {
